<!-- Updates made to documentation on 3/24/21 by Aaron P. Woods, Sr. PM of the UXA Team in Atlanta.  -->

<a name="manage-a-resource"></a>
# Manage a Resource
...
<a name="manage-a-resource-context"></a>
## Context
Users need to manage all aspects of an Azure resource.

<a name="manage-a-resource-problem"></a>
## Problem
...
<a name="manage-a-resource-solution"></a>
## Solution
...
<a name="manage-a-resource-solution-previously-known-as"></a>
### Previously known as
* Resource blade
* Resource detail
* Resource menu
...
<a name="manage-a-resource-examples"></a>
## Examples

<a name="manage-a-resource-examples-example-images"></a>
### Example images
...
<a name="manage-a-resource-examples-example-uses"></a>
### Example uses
...
<a name="manage-a-resource-use-when"></a>
## Use when
...
<a name="manage-a-resource-the-manage-a-resource-experience"></a>
## The “Manage a Resource” Experience

<a name="manage-a-resource-the-manage-a-resource-experience-overview-page"></a>
### Overview Page
...
<a name="manage-a-resource-the-manage-a-resource-experience-resource-menu"></a>
### Resource Menu
...
<a name="manage-a-resource-the-manage-a-resource-experience-resource-pages"></a>
### Resource Pages
...
<a name="manage-a-resource-anatomy-overview-page"></a>
...
<a name="manage-a-resource-behavior-overview-page"></a>
## Behavior: Overview Page

<a name="manage-a-resource-behavior-overview-page-title"></a>
### Title
...
<a name="manage-a-resource-behavior-overview-page-resource-menu-1"></a>
### Resource Menu
...
<a name="manage-a-resource-behavior-overview-page-resource-menu-1-strong-learn-more-strong"></a>
...
<a name="manage-a-resource-behavior-overview-page-overview-page-toolbar"></a>
### Overview Page Toolbar
The Toolbar is used to perform default and resource-specific actions on the Overview Page.

<a name="manage-a-resource-behavior-overview-page-overview-page-essentials-area"></a>
...
<a name="manage-a-resource-behavior-overview-page-overview-page-content-area"></a>
...
<a name="manage-a-resource-anatomy-resource-menu"></a>
...
<a name="manage-a-resource-behavior-resource-menu"></a>
## Behavior: Resource Menu

<a name="manage-a-resource-behavior-resource-menu-search-input-field"></a>
### Search Input Field
...
<a name="manage-a-resource-behavior-resource-menu-top-level-group"></a>
### Top-level Group
...
<a name="manage-a-resource-behavior-resource-menu-settings-group"></a>
### Settings Group
...
<a name="manage-a-resource-behavior-resource-menu-resource-specific-group"></a>
...
<a name="manage-a-resource-behavior-resource-menu-monitoring-group"></a>
### Monitoring Group
...
<a name="manage-a-resource-behavior-resource-menu-automation-group"></a>
### Automation Group
...
<a name="manage-a-resource-behavior-resource-menu-support-troubleshooting-group"></a>
...
<a name="manage-a-resource-anatomy-overview-page-toolbar"></a>
...
<a name="manage-a-resource-behavior-overview-page-toolbar"></a>
## Behavior: Overview Page Toolbar

<a name="manage-a-resource-behavior-overview-page-toolbar-primary-command"></a>
### Primary Command
...
<a name="manage-a-resource-behavior-overview-page-toolbar-other-command-s"></a>
### Other Command(s)
...
<a name="manage-a-resource-behavior-overview-page-toolbar-common-commands"></a>
### Common Commands
...
<a name="manage-a-resource-anatomy-overview-page-essentials-area"></a>
...
<a name="manage-a-resource-behavior-overview-page-essentials-area"></a>
## Behavior: Overview Page Essentials Area

<a name="manage-a-resource-behavior-overview-page-essentials-area-left-side-essentials-items"></a>
...
<a name="manage-a-resource-behavior-overview-page-essentials-area-right-side-essentials-items"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-get-started-content-strong"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-properties-content-strong"></a>
...
* Section content
  * Icon and title should match corresponding Resource Menu item
  * The title should be a hyperlink that activates the Resource Menu item
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-monitoring-content-strong"></a>
...
* Include chart filters at the top of the page above all charts.
* Include a hyperlink with the text “Click for additional metrics” that allows the user to access more data.

<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-capabilities-content-strong"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-recommendations-content-strong"></a>
...
<a name="manage-a-resource-anatomy-overview-page-content-area-behavior-overview-page-content-area-strong-example-tutorials-content-strong"></a>
...
<a name="manage-a-resource-don-t"></a>
## Don&#39;t
...
<a name="manage-a-resource-related-design-guidelines"></a>
...
<a name="manage-a-resource-research-and-usability"></a>
...
<a name="manage-a-resource-telemetry"></a>
## Telemetry
