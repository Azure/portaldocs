...
| Microsoft.Portal.Framework | Contains framework assemblies required for self-hosting the extension. See [How to migrate off self-hosting](http://aka.ms/portalfx/frameworknuget). |
...
| Microsoft.Portal.Tools.ContentUnbundler | This NuGet has been deprecated. The recommended practice is to generate HostingService artifacts as part of native build. [Extension Hosting Service](top-extensions-hosting-service.md). |
