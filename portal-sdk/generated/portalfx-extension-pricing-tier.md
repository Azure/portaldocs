...
const specsDropDown = new FxSpecsDropDown(container, { // tslint:disable-line:deprecation
    ...
    contextPane: true,
} as FxSpecsDropDown.OptionsWithBladeReference); // tslint:disable-line:deprecation
